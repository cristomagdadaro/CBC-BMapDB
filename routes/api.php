...
Route::middleware(['api','auth:sanctum','verified'])->group(function() {
    ...
    Route::middleware(['check.status.breedersmap'])->prefix('breeders')->group(function () {
        Route::middleware('can:'. Permission::READ_BREEDER->value)->get('/{parent_id?}/', [BreederController::class, 'index'])->name('api.breeders.index');
        ...
        Route::middleware('can:'. Permission::READ_BREEDER->value)->get('/summary/{parent_id?}/', [CommodityController::class, 'summary'])->name('api.breeders.summary');
