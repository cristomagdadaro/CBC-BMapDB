...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\TWGProject>
 */
class TWGProjectFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'expected_output' => $this->faker->paragraph(),
            'project_leader' => $this->faker->name(),
            'funding_agency' => $this->faker->randomElement(['DOST', 'PCA-CRDP']),
