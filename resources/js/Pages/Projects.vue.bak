        ...
        <div class="grid grid-cols-1 body-grid-rows w-full bg-transparent">
            ...
            <public-page-section class="flex items-center">
                ...
                <p class="text-normal text-center text-light-color">
                    The center is a premier hub for innovation and research in agricultural biotechnology. Dedicated to
                    advancing crop productivity and sustainability, the center provides cutting-edge solutions,
                    resources, and technologies to support farmers, researchers, and stakeholders in addressing the
                    challenges of food security and agricultural development.
                </p>
            </public-page-section>
            <public-page-section class="flex items-center text-center">
                <div class="flex flex-col gap-5 justify-between items-center">
                    ...
                    <p class="text-normal text-dark-color">
                        ...
                        meticulously curated to support your crop biotechnology research endeavors. Within this digital
                        resource, you will find a comprehensive collection of data, tools, and resources designed to
                        facilitate your scientific investigations, accelerate discoveries, and drive innovation in the
