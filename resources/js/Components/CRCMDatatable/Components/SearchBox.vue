<template>
    <div class="flex flex-col gap-0.5">
        ...
        <div class="flex items-center gap-0.5 border-black bg-white rounded shadow">
            <input class="border-0 py-1.5 rounded-l" type="text" v-model="search" id="dtSearch" @keyup="typing($event.target.value)" placeholder="Find it here" @keyup.capture.delete="!search.length?searchBy():null" @keyup.capture.enter="searchBy" />
