<template>
    <div class="flex flex-col gap-0.5">
        ...
        <div class="flex flex-row items-center justify-between gap-0.5 border-black bg-white rounded shadow focus-within:ring-1">
            ...
            <button class="p-2 rounded-r hover:border-0 active:scale-90 duration-300 hover:bg-gray-300 active:bg-gray-400 h-full" @click="searchBy"><search-icon class="h-5 w-5" /></button>
        </div>
    </div>
</template>
<script>
