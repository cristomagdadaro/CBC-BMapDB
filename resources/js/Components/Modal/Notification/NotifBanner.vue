...
const copyToClipboard = (notify) => {
    ...
    navigator.clipboard.writeText(textToCopy).then(() => {
        ...
        console.log('Notification details copied to clipboard');
    }).catch(err => {
                ...
                >
                    <div v-show="notify.show"
                        ...
                        >
                            ...
                            <close-icon
                                class="w-6 h-auto text-gray-400 hover:text-gray-700 hover:rotate-90 duration-300"/>
                        </button>
                    </div>
                </transition>
            </template>
