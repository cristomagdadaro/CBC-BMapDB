...
class BreedersTest extends TestCase
{
    ...
    {
        $this->userSetup();
        $response = $this->deleteJson('/api/breeders/delete/1');
        $response->assertStatus(200);
    ...
    {
        $this->userSetup();
        $response = $this->deleteJson('/api/breeders/delete/999');
        $response->assertStatus(404);
    }
    ...
    {
        $this->userSetup();
        $response = $this->putJson('/api/breeders/update/1', [
            'name' => 'Test Breeder',
            'agency' => 'Test Agency',
            'address' => 'Test Address',
            'phone' => 'Test Phone',
    ...
    {
        $this->userSetup();
        $response = $this->putJson('/api/breeders/update/999', [
            'name' => 'Test Breeder',
            'agency' => 'Test Agency',
            'address' => 'Test Address',
            'phone' => 'Test Phone',
    ...
    public function update_a_user_with_used_email(): void
    {
        ...
        $response = $this->putJson('/api/breeders/update/'. $breeder->id,[
            'name' => 'Test Breeder',
            'agency' => 'Test Agency',
            'address' => 'Test Address',
            'phone' => 'Test Phone',
